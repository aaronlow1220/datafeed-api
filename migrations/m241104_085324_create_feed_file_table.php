...
class m241104_085324_create_feed_file_table extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable($this->table, [
            ...
            'file_id' => $this->bigInteger(20)->unsigned()->notNull()->comment('ref: file.id'),
            'filter' => $this->text()->notNull()->comment('Custom filter, JSON format'),
            'utm' => $this->string(255)->notNull()->comment('Utm parameter'),
